...
public class ListGORVolly_userFragment extends Fragment {
    ...
    public ListGORVolly_userFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_gorvolly_user, container, false);

...
public class VollyMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void loaddata(){
        ...
        Call<ListGOR_user> call = apiPackage.gor_user("4");
            ...
            public void onResponse(Call<ListGOR_user> call, Response<ListGOR_user> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for(int i = 0; i < results.size(); i++){
                        ...
                        if (true){
                            Geocoder geocoder = new Geocoder(VollyMapsActivity.this);
        ...
        switch (requestCode){
            case PERMISSION_REQUEST:
                if (grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(VollyMapsActivity.this,"Permission Dennied",Toast.LENGTH_SHORT).show();
                }
                return;
        }
    }

...
public class MapsAllActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
        ...
        private List<ResultAllGOR> results = new ArrayList<>();
        ...
        public void loaddata(){
            ...
            Call<ListAllGOR> call = apiPackage.listAllGOR();

            call.enqueue(new Callback<ListAllGOR>() {
                @Override
                public void onResponse(Call<ListAllGOR> call, Response<ListAllGOR> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for(int i = 0; i < results.size(); i++){
                            ...
                            if (true){
                                Geocoder geocoder = new Geocoder(com.example.xeylyne.project.Activitys.MapsAllActivity.this);
                ...
                @Override
                public void onFailure(Call<ListAllGOR> call, Throwable t) {
                    Log.d("ASD","gagal");
                    dialog.hide();
                }
            });
            ...
            switch (requestCode){
                case PERMISSION_REQUEST:
                    if (grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                        ...
                        Toast.makeText(com.example.xeylyne.project.Activitys.MapsAllActivity.this,"Permission Denait",Toast.LENGTH_SHORT).show();
                    }
                    return;
            }
        }

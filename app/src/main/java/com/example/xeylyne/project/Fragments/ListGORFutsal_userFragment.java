...
public class ListGORFutsal_userFragment extends Fragment {
    ...
    public ListGORFutsal_userFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_list_gorfutsal_user, container, false);

...
import com.example.xeylyne.project.Fragments.ListGORFutsal_userFragment;
...
public class FutsalActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = new ListGORFutsal_userFragment();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.navigation_dashboard:
                Intent intent = new Intent(FutsalActivity.this, MapsFutsalActivity.class);
